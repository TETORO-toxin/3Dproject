...
// �T�v:
//  - �⏕���j�b�g�iAux�j�̊Ǘ��Ɛ퓬�֘A�����������t�@�C���B
//  - Aux �̔��ˁA�Q�[�W�񕜁A�o����Ԃ̊Ǘ��Ȃǂ� API ��񋟂��܂��B
...
// `newWeapon` �𑕔����悤�Ƃ���B���������������ꍇ�� true ��Ԃ��A
// �ȑO�̑����� `oldOut` �ɏ������ށinullptr �łȂ���΁j�B
// `newWeapon` �����݂̑����Ɠ����ŕύX���Ȃ������ꍇ�� false ��Ԃ��B
...
// ����݊��p�̃w���p�[: �������s��ꂽ�ꍇ�͈ȑO�̕����Ԃ��A
// �����łȂ��ꍇ�� `Game::WeaponType::None` ��Ԃ��B
